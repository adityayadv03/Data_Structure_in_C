/*Author :- Aditya Yadav */
#include<stdio.h> //The Logic of Creation and Insertion is Same we Just Need to Call the Same Fucntion we have Called in the Creation
#include<stdlib.h> //Program to Implement the insertion operationin Binary Search Tree
...
int main()
{
    ...
    scanf("%d",&ele);
    createBST(root,ele); //Calling the Function to insert
